...
public class Country implements Comparable
{
    ...
    public boolean equals(Object obj) {
		if (obj instanceof Country) {					// downcasting from Object to Country
			Country otherCountry = (Country) obj;		// cast obj to Country 
			
			// #TODO
			if (this.name.equals(otherCountry.getName()) &&
					this.powerLevel == otherCountry.getPowerLevel() &&
					this.nationalDish.equals(otherCountry.getNationalDish())) {
				return true;
			}	
		}
		return false;
